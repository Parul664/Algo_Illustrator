...
class Dijkstraa:
    def __init__(self,window,V,E,limx,limy,direct,weighted,weights):
        ...
        self.mat = dis_matrix(self.window,limx,limy)

        #display the priority queu
        self.pq = p_queue(window,300,limx,limy)
        self.pq.show_skeleton()
    ...
    def reset(self,vertex_rad = 20):
        ...
        self.pq.fill_pq(self.vert_sorted,self.vertDis)
        self.mat.show(self.vertDis)
        pygame.display.update()
    ...
    def algo(self,count):
        ...
        if self.vert_sorted:
            ...
            s = "Exploring its children of "+str(v)+"... "
